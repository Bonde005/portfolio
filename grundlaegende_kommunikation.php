...
<html lang="da">
    <head>
        ...
        <title>AB læringsportfolio Grundlæggende kommunikation</title>
        ...
        <link rel="stylesheet" href="grid_grundlaegende_kommunikation.css">
    </head>
    <body>
      ...
      <div id="pagewrap">
        ...
        <section id="indledning" class="tekstfelt">
          <p>Kommunikation er mere end dialog. Der findes tre former for kommunikation:</p>
          <dl>
              <dt>Verbal</dt>
              <dt>Nonverbal kommunikation</dt>
                <dd>Kroppen (gestik)</dd>
                <dd>Ansigtet (mimik)</dd>
              <dt>Skriftlig kommunikation</dt>
          </dl>
          <p>Altså er der den verbale kommunikation som de fleste kender i sin hverdag f.eks. i form af en dialog mellem to mennesker. Derudover er der også det nonverbale kommunikationen som er alle de signaler mennesker sender med kroppen og ansigtet. Den nonverbale kommunikation bruges ofte til at hjælpe modtageren af kommunikationen med at tolke det verbale der kommunikeres. Derudover er der skriftlig kommunikation som der ofte er i bl.a. bøger, på hjemmesider og på sociale medier. </p>
        ...
        <section id="grundantagelser_overskrift" class="under_overskrift">
          <h2>Grundantagelser</h2>
        </section> <!-- kodning_overskrift -->

        <section id="grundantagelser_tekst" class="tekstfelt">
          <p>Der er fem grundantagelser om kommunikation:</p>
          <ol>
            <li>Man kan ikke ikke-kommunikere.</li>
            <li>Enhver kommunikation består af to dele: Selve indholdet om det faktiske emne på den ene side og på den anden side oplysninger om det indbyrdes forhold, der er mellem dem, der kommunikerer.</li>
            <li>Den måde, vi udtrykker os på, og den måde, vi tolker hinandens kommunikation på, afhænger også af det forhold, vi har til hinanden.</li>
        ...
        <section id="grundantagelser_eksempel" class="illustrationer">
          <img src="billeder/kommunikation/kommunikationproces.png" alt="Illustration af kommunikationproces">
          <blockquote>
            <p>Kommunikationsproces hvor kommunikationen bliver påvirket af forståelsesen af hinanden</p>
          </blockquote>
        </section> <!-- grundantagelser_eksempel -->

        <section id="paradigmer_overskrift" class="under_overskrift">
          <h2>Paradigmer</h2>
        </section> <!-- paradigmer_overskrift -->
        ...
        <section id="humanistisk_paradigme" class="boks">
          <section id="humanistisk_paradigme_overskrift" class="under_overskrift">
            <h3>Det humanistiske paradigme</h3>
          </section> <!-- humanistisk_paradigme_overskrift -->
          ...
          <section id="imk_model" class="illustrationer">
            <img src="billeder/kommunikation/imkmodel.jpg" alt="IMK-modellen">
            <blockquote>
              <p>Illustration af IMK-modellen</p>
            </blockquote>
          </section> <!-- imk_model -->
        </section> <!-- humanistisk_paradigme boks -->

        <section id="samfundsvidenskabelig_paradigme" class="boks">
          <section id="samfundsvidenskabelig_paradigme_overskrift" class="under_overskrift">
            <h3>Det samfundsvidenskabelige paradigme</h3>
          </section> <!-- samfundsvidenskabelig_paradigme_overskrift -->
          ...
          <section id="laswells_formel" class="illustrationer">
            <img src="billeder/kommunikation/lasswelss_formel.jpg" alt="Laswells Formel">
            <blockquote>
              <p>Illustration af Laswells formel</p>
            </blockquote>
          </section> <!-- laswells_formel -->
        </section> <!-- samfundsvidenskabelig_paradigme boks -->
      </div> <!-- pagewrap -->
