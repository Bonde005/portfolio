...
<html lang="da">
    <head>
        ...
        <title>Læringsportofolie html</title>
      ...
      <header>
        ...
        <nav id="global_menu">
          ...
          <section class="dropdown" id="menu_kommunikation">
            <section  class="menu_punkt">
              <h1>Kommunikation</h1>
            </section> <!-- menu_punkt kommunikation -->
            <section class="dropdown_content">
              <div class="column_left">
          ...
          <section class="dropdown" id="menu_grafisk_design">
            ...
            </section> <!-- menu_punkt Grafisk Design -->
            <section class="dropdown_content">
              <div class="column_left">
      ...
      <div id="pagewrap">
        ...
        <section id="indledning" class="tekstfelt">
          ...
          <section id="lokal_menu">
            ...
            <a href="#kodning_overskrift"><h2>Kodning</h2></a>
            <a href="#kodeskik_overskrift"><h2>Kodeskik</h2></a>
          </section>
        </section> <!-- indledning -->
        ...
        <section id="tags_tekst" class="tekstfelt">
          <div class="tekst">
          ...
          <a class="kilde" href="https://www.w3schools.com/tags/ref_byfunc.asp "><p>w3schools.com</p></a>
        </section> <!-- tags_tekst -->

        <section id="tags_eksempler" class="illustrationer">
          <img src="billeder/websites/html/tags_eksempler.png" alt="Eksempler af tags">
          <blockquote>
            <p>Eksempel på hvordan html kan opbygges, og hvad de forskelige tags gør</p>
          </blockquote>
        </section> <!-- tags_eksempler -->

        <section id="semantik_tekst" class="tekstfelt">
          <div class="tekst">
