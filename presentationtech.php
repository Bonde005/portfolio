...
<html lang="da">
    <head>
        ...
        <title>AB læringsportfolio Præsentationsteknink</title>
        ...
        <link rel="stylesheet" href="grid_presentationtech.css">
    </head>
    <body>
      ...
      <div id="pagewrap">
        ...
        <section id="indledning" class="tekstfelt">
          ...
          <section id="lokal_menu">
            ...
            <a href="#forberedelse_overskrift"><h2>Forberedelse</h2></a>
          </section>
        </section> <!-- indledning -->

        <section id="nonverbal_overskrift" class="under_overskrift">
          <h2>Nonverbal kommunikation</h2>
        </section> <!-- nonverbal_overskrift -->

        <section id="nonverbal_tekst" class="tekstfelt">
          <div class="tekst">
            <p>Førstehåndsindtryk betyder meget for mennesker, og sættes sig fast i ens bevidsthed. Det er vist at kun 7% af indtrykket kommer fra verbal kommunikation. Derfor er det vigtigt at tænke sig over sin nonverbale kommunikation i forbindelse med en præsentation. Nonverbal kommunikation omhandler:</p>
          </div> <!-- tekst -->
          <div class="punkter">
            <ul>
              <li>Kropssprog</li>
        ...
        <section id="forberedelse_overskrift" class="under_overskrift">
          <h2>Forberedelse</h2>
        ...
        <section id="tredje_fase_tekst" class="tekstfelt">
          <p>I tredje fase skal man arbejde på at sætte ord på præsentationen og finder ud af hvordan man bedst hensigtsmæssigt formulere sig. Der er her fire grundlæggende krav til et godt formidlingssprog:</p>
          <ul>
            <li>Korrekt</li>
            <li>Klart</li>
            <li>Tilpasset</li>
        ...
        <section id="sprog_billede" class="illustrationer">
          <img src="billeder/kommunikation/klar_kommunikation.png" alt="Klart sprog">
          <blockquote>
            <p>Man skal have styr på sit sprog for at formidle som ønsket</p>
            <a class="kilde" href="http://www.clearlanguage.net/wp-content/uploads/2018/11/main_logo.png"><p>Inspireret af clearlanguage.net</p></a>
          </blockquote>
        ...
        <section id="powerpoint_billede" class="illustrationer">
          <img src="billeder/kommunikation/death_by_pp.jpg" alt="Death by PowerPoint">
          <blockquote>
            <p>Udbreddelsen af dårlige PowerPoint præsentationer har ført til talemåden "death by PowerPoint"</p>
            <a class="kilde" href="https://marketoonist.com/wp-content/uploads/2015/06/111205.powerpoint.jpg"><p>marketoonist.com</p></a>
          </blockquote>
        </section> <!-- powerpoint_billede -->
        ...
        <section id="femte_fase_tekst" class="tekstfelt">
          ...
          <div class="punkter">
            ...
            <ul>
              ...
              <li>Hvilke signaler sender det tøj, jg har valgt at tage på?</li>
